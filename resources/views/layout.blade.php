...
<head>
    ...
    <style>
        ...
        .backup-code-block {padding: 20px 10px;margin: 0;background-color: #efefef;color: #444;font-size: 15px;} .backup-code {font-size: 23px;} span {font-size: 14px;color: #505050; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'} span.block{display: block} .mb-15{margin-bottom:15px} .btn--primary {display: block;padding: 10px;border: 0;text-decoration: none;color: #fff!important;width: fit-content;margin: auto;background-color: #009EF7}
    </style>
</head>
<body>
                ...
                <tr>
                    <td class="header">
                        <a href="{{ route('home') }}" style="display: inline-block;">
                            <img src="{{ asset('img/logo-im.png') }}" class="logo" alt="Logo">
                        </a>
                    </td>
                </tr>
